...
var config = {
  ...
  onPrepare: function() {
    ...
    // // Connect to Redis
    // var redisClient = redis.createClient(serverConfig.redisConfig.port, serverConfig.redisConfig.host);
    // console.log(serverConfig.redisConfig.port, serverConfig.redisConfig.host);

    // Setup rethinkdb for tests
    ...
    function onConnect(callback) {
      r.connect({
        host: serverConfig.dbConfig.host,
        port: serverConfig.dbConfig.port,
        db: serverConfig.dbConfig.db
